...
public class BlockingClip extends AudioStream {
	...
	/*
	 * This guy could throw a bunch of exceptions. We're going to wrap them all in a
	 * custom exception handler that is a RuntimeException so we don't have to catch
	 * and throw all these exceptions.
	 */
	@Override
	public void open() {
		lock.lock();
